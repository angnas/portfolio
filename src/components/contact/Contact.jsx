...
const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_m1xde0m', 'template_srnfyh7', formRef.current, {
        publicKey: '6oghxrlD6XcNH1RDX',
      })
      .then(
        () => {
            setSuccess(true)
  ...
  return (
    ...
    variants={variants}
        ...
        <motion.div className="textContainer" >
            ...
            <motion.div className="item">
                <h2>Resume</h2>
                <a href="https://docs.google.com/document/d/1JqYz2ek4lNogIi16lngB3ivWysQr6UAAd7HaQwJ8I7Q/edit" download target="_blank" rel="noopener noreferrer">
                <span>Resume</span>
